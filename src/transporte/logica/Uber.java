...
public class Uber extends Transportes{
    ...
    public void rutaCalculada(){
        ...
        tiemposeg=cuadras*20;
        min=tiemposeg/60;
        hora=min/60;
        costo=cuadras*150;
        System.out.println("      "+"--Pedir Vehiculo por la aplicacion Uber"); 
        System.out.println("      "+"Iniciar recorrido en Uber desde la calle "+callei+" con carrera "+carrerai+" hasta la calle "+callef+" con carrera "+carreraf);
        System.out.println("      "+"Costo aproximado Uber: "+costo+" pesos");
