...
public class Caminar extends Transportes{
    ...
    public void rutaCalculada(){
        ...
        tiemposeg=cuadras*70;
        min=tiemposeg/60;
        hora=min/60;
        
        System.out.println("      "+"Caminar desde la calle "+callei+" con carrera "+carrerai+" hasta la calle "+callef+" con carrera "+carreraf);
        if(x1<x2){
        ...
        if(x1>x2){
            System.out.println("      "+"--Caminar "+calle+" calles al sur");
            if(y1<y2){
                System.out.println("      --y "+"Caminar "+carrera+" carreras al oeste");
            }
            if(y1>y2){
        ...
        if(x1==x2){
            if(y1<y2){
                System.out.println("      "+"--Caminar "+carrera+" carreras al oeste");
            }
            if(y1>y2){
